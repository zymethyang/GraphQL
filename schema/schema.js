    ...
    fields: () => ({
        ...
        users: {
            ...
            resolve(parentValue, args) {
                return axios.get(`http://localhost:3000/users?companiesId=${parentValue.id}`).then(response => response.data)
            }
        }
    })
})
...
const UserType = new GraphQLObjectType({
    ...
    fields: {
        ...
        company: {
            type: CompanyType,
            resolve(parentValue, args) {
                return axios.get(`http://localhost:3000/companies/${parentValue.companiesId}`)
    ...
    fields: {
        addUser: {
            ...
            args: {
                ...
                companiesId: { type: GraphQLString }
            },
